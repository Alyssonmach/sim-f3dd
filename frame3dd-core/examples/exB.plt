...
set xyplane 0 
  plot '/tmp/frame3dd_temp_alysson//exB-msh' u 2:3 t 'undeformed mesh' w lp lw 1 lt 5 pt 6, '/tmp/frame3dd_temp_alysson//exB-mshf.001' u 1:2 t 'load case 1 of 2' w l lw 1 lt 3
# splot '/tmp/frame3dd_temp_alysson//exB-msh' u 2:3:4 t 'load case 1 of 2' w lp  lw 1 lt 5 pt 6, '/tmp/frame3dd_temp_alysson//exB-mshf.001' u 1:2:3 t 'load case 1 of 2' w l lw 1 lt 3
pause -1
set title "Example A: linear static analysis of a 2D truss with support settlement (kips in)  \nanalysis file: ../examples/exA.3dd   deflection exaggeration: 50.0   load case 2 of 2 "
unset clip; 
set clip one; set clip two
set xyplane 0 
  plot '/tmp/frame3dd_temp_alysson//exB-msh' u 2:3 t 'undeformed mesh' w lp lw 1 lt 5 pt 6, '/tmp/frame3dd_temp_alysson//exB-mshf.002' u 1:2 t 'load case 2 of 2' w l lw 1 lt 3
# splot '/tmp/frame3dd_temp_alysson//exB-msh' u 2:3:4 t 'load case 2 of 2' w lp  lw 1 lt 5 pt 6, '/tmp/frame3dd_temp_alysson//exB-mshf.002' u 1:2:3 t 'load case 2 of 2' w l lw 1 lt 3
